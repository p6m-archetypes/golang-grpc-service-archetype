...
local ci_project = prova.fixture("standards[golang-grpc/None]:project", Scope.File, function(ctx)
	return archetect.render{
		source = SRC,
		answers = {
			author_name = "Test Author",
...
prova.group("golang-grpc[None]:ci", { requires = { "docker" }, tags = { "standards" } }, function(g)
